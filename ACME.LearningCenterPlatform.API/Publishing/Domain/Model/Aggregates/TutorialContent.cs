...
public partial class Tutorial : IPublishable
{
    ...
    private bool ExistsImageByUrl(string imageUrl) => Assets.Any(asset => 
        asset.Type == EAssetType.Image && (string)asset.GetContent() == imageUrl);
    private bool ExistsVideoByUrl(string videoUrl) => Assets.Any(asset => 
        asset.Type == EAssetType.Video && (string)asset.GetContent() == videoUrl);
    private bool ExistsReadableContent(string content) => Assets.Any(asset => 
    ...
    //TODO: Implement get content method
}